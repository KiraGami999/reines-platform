  ...
  return (
    <div className={className}>
      <button
        ...
        disabled={loading}
        className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#2d4a6b] px-3 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#1a2f4a] disabled:opacity-60"
      >
