        ...
        {canAward && (
          <form onSubmit={awardPoints} className="mt-4 space-y-3 rounded-xl border border-zinc-100 bg-zinc-50 p-4">
            ...
            <button
              type="submit"
              disabled={saving}
              className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#2d4a6b] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1a2f4a] disabled:opacity-60"
            >
