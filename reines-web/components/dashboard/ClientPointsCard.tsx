...
export function ClientPointsCard({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white">
      ...
      <div className="p-5">
        <div className="rounded-xl bg-[#35475D] p-4 text-white">
        ...
        {canAward && (
          <form onSubmit={awardPoints} className="mt-4 space-y-3 rounded-xl border border-zinc-100 bg-zinc-50 p-4">
            ...
            <button
              type="submit"
              disabled={saving}
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#35475D] px-4 py-2 text-sm font-semibold text-white hover:bg-[#283546] disabled:opacity-60"
            >
