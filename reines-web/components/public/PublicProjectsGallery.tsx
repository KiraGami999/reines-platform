...
import { ArrowRight, CalendarDays, MapPin, Maximize2, Tag, X } from "lucide-react";
              ...
              <div className="flex flex-col p-6 sm:p-8 lg:p-10">
                ...
                <div className="mt-8 rounded-2xl bg-zinc-50 p-5">
                  ...
                  <p className="mt-2 text-sm leading-7 text-zinc-600">
                    This information is controlled from the admin portal. Admins can update the picture, description, status, project type, location, and year/date range as client-approved project details become available.
                  </p>
                </div>
