    ...
    return (
      <div className="space-y-1">
        ...
        <input
          ...
          required={required}
          className={cn(
            "block w-full rounded-lg border px-3 py-2 text-sm text-zinc-900 caret-[#35475D] placeholder:text-zinc-400 transition-colors focus:outline-none focus:ring-2 dark:text-[var(--foreground)]",
            error
