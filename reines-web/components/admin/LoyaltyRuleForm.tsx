...
export function LoyaltyRuleForm({ initial }: LoyaltyRuleFormProps) {
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-5 space-y-4">
      ...
      {preview && (
        <div className="rounded-xl border border-[#8fb9e8]/30 bg-[#8fb9e8]/10 px-4 py-2 text-sm text-[#35475D] font-medium">
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={handleSave}
          disabled={saving}
          className="inline-flex items-center gap-1.5 rounded-xl bg-[#35475D] px-4 py-2 text-sm font-medium text-white hover:bg-[#283546] transition-colors disabled:opacity-60"
        >
