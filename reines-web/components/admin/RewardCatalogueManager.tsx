  ...
  return (
    <div className="rounded-xl border border-[#8fb9e8]/40 bg-[#8fb9e8]/5 p-4 space-y-3">
      ...
      <div className="flex gap-2">
        <button onClick={handleSubmit} disabled={saving} className="inline-flex items-center gap-2 rounded-lg bg-[#2d4a6b] px-4 py-2 text-sm font-medium text-white hover:bg-[#1a2f4a] transition-colors disabled:opacity-60">
          {saving ? <Loader2 size={13} className="animate-spin" /> : <CheckCircle2 size={13} />}
          Save Reward
        </button>
        <button onClick={onCancel} className="px-4 py-2 text-sm font-medium text-zinc-600 border border-zinc-300 rounded-lg hover:bg-zinc-50 transition-colors">
          Cancel
        </button>
      </div>
    </div>
      ...
      <div className="flex items-center justify-between">
        ...
        {!adding && (
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-[#2d4a6b] px-3 py-2 text-xs font-medium text-white hover:bg-[#1a2f4a] transition-colors"
          >
