...
const adminNav: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Market Insights",  href: "/dashboard/admin/market-insights", icon: LineChart },
      { label: "Client Logos",     href: "/dashboard/admin/client-logos", icon: Building },
      { label: "Portal Greetings", href: "/dashboard/admin/greetings", icon: MessageSquareText },
