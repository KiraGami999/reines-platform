        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 md:grid-cols-2">
            <div className="rounded-2xl border border-zinc-100 p-8 dark:border-[var(--border)] dark:bg-[var(--surface)]">
              ...
              <h2 className="mt-4 text-2xl font-bold text-[#35475D] dark:text-[#8fb9e8]">Our Mission</h2>
            ...
            <div className="rounded-2xl bg-[#35475D] p-8">
      ...
      <section className="bg-zinc-50 py-12 dark:bg-[var(--surface-muted)] sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-2 text-3xl font-bold text-[#35475D] dark:text-[#8fb9e8]">Our Core Values</h2>
          </div>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {values.map((v) => {
              ...
              return (
                ...
                <h3 className="mt-3 font-semibold text-[#35475D] dark:text-[#8fb9e8]">{v.title}</h3>
      ...
      <section className="bg-white py-12 dark:bg-[var(--background)] sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-2 text-3xl font-bold text-[#35475D] dark:text-[#8fb9e8]">What Reines Provides</h2>
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-6 dark:border-[var(--border)] dark:bg-[var(--surface-muted)]">
              <div className="mb-5 flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-[#35475D] dark:text-[#8fb9e8]">Products</h3>
              </div>
              <ul className="space-y-3 rounded-xl border border-zinc-200 bg-white p-5 dark:border-[var(--border)] dark:bg-[var(--surface)]">
                {productClasses.map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-3 border-b border-zinc-100 pb-3 text-sm font-semibold text-[#35475D] last:border-b-0 last:pb-0 dark:border-[var(--border)] dark:text-[#8fb9e8]"
                  >
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#8fb9e8]/15 text-[#35475D] dark:text-[#8fb9e8]">
            ...
            <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-6 dark:border-[var(--border)] dark:bg-[var(--surface-muted)]">
              <div className="mb-5 flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-[#35475D] dark:text-[#8fb9e8]">Services</h3>
              </div>
              <ul className="space-y-3 rounded-xl border border-zinc-200 bg-white p-5 dark:border-[var(--border)] dark:bg-[var(--surface)]">
      ...
      <section className="bg-zinc-50 py-12 dark:bg-[var(--surface-muted)] sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-2 text-3xl font-bold text-[#35475D] dark:text-[#8fb9e8]">Registered Details</h2>
          </div>
          <div className="mt-10 divide-y divide-zinc-200 overflow-hidden rounded-2xl border border-zinc-200 bg-white dark:divide-[var(--border)] dark:border-[var(--border)] dark:bg-[var(--surface)]">
            <div className="p-6">
              <p className="leading-relaxed text-zinc-600 dark:text-[var(--text-secondary)]">
                Reines Property Development Limited was registered and incorporated in Blantyre, Malawi on March 29, 2023 with registration number <span className="font-semibold text-[#35475D] dark:text-[#8fb9e8]">COY-REFW2A</span> as a private limited company under the Companies Act, 2013.
              </p>
            </div>
            {companyInfo.map((item) => (
              <div key={item.label} className="grid gap-2 p-5 sm:grid-cols-[220px_1fr]">
                <p className="font-semibold text-[#35475D] dark:text-[#8fb9e8]">{item.label}</p>
