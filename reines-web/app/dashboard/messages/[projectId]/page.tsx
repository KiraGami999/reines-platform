          ...
          <div className="flex shrink-0 items-center justify-between border-b border-zinc-100 bg-white px-5 py-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <Link
                ...
                className="hidden sm:flex items-center gap-1.5 rounded-lg border border-zinc-100 px-3 py-1.5 text-xs font-medium text-zinc-500 transition-colors hover:border-zinc-200 hover:bg-zinc-50 hover:text-zinc-800"
              >
