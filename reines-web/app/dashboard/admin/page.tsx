  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#35475D]">Admin Panel</h1>
        ...
        {CARDS.map((card) => (
          ...
          >
            <div>
              ...
              <h2 className="text-base font-semibold text-[#35475D] mb-1">{card.title}</h2>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <span className="flex items-center gap-1 text-xs font-medium text-[#35475D] group-hover:gap-2 transition-all">
